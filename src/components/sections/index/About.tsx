...
export default function About() {
  let otherTech: Tech[] = [
    ...
    { title: "Boosty", icon: <img alt="" draggable={false} className="h-6" src="https://r2.e-z.host/e7a4ea07-ae15-4aaa-9512-6d3ff6fcbeb4/8681ep4r4c7whd56ps.jpg" />, link: "https://boosty.to" },
